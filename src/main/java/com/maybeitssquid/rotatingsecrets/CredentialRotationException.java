 ...
 *
 * <p>This exception wraps underlying errors that occur during the credential rotation process, such
 * as failures to update connection pool credentials or refresh pool connections.
 *
